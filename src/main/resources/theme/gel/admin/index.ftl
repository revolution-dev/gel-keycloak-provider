...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="${resourceUrl}/assets/index.b9f9a2d2.js"></script>
  ...
  <body>
    ...
    <script id="environment" type="application/json">
    {
      ...
      "commitHash": "07336dc9c69c0adb7832b63ba9e626f121e4c99f",
      "isRunningAsTheme": true
    }
  </script>

  <script src="${resourceUrl}/js/gel-saml-admin-extension.js" defer></script>
</body>
</html>
